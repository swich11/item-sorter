...
ObjectVisualiser::ObjectVisualiser() : Node("visualiser") {
    ...
    marker_label_map = {
        ...
        {"RedHexagon", ObjectMarkerInfo{ObjectID::RedHexagon, Marker::CYLINDER, 255.0, 0.0, 0.0, 1.0, 1.0, 1.0, true, 
        ...
        {"GreenHexagon", ObjectMarkerInfo{ObjectID::GreenHexagon, Marker::CYLINDER, 0.0, 255.0, 0.0, 1.0, 1.0, 1.0, true, 
            "package://visualisation/meshes/hex_prism.stl"}},
        ...
        {"BlueHexagon", ObjectMarkerInfo{ObjectID::BlueHexagon, Marker::CYLINDER, 0.0, 0.0, 255.0, 1.0, 1.0, 1.0, true, 
            "package://visualisation/meshes/hex_prism.stl"}},
        {"CircleBucket", ObjectMarkerInfo{ObjectID::CircleBucket, Marker::CYLINDER, 255.0, 0.0, 0.0, 1.0, 1.0, 1.0, true, 
            "package://visualisation/meshes/circle_bin.stl"}},
        {"SquareBucket", ObjectMarkerInfo{ObjectID::SquareBucket, Marker::CYLINDER, 0.0, 0.0, 255.0, 1.0, 1.0, 1.0, true, 
            "package://visualisation/meshes/square_bin.stl"}},
        {"HexagonBucket", ObjectMarkerInfo{ObjectID::HexagonBucket, Marker::CYLINDER, 0.0, 255.0, 0.0, 1.0, 1.0, 1.0, true, 
